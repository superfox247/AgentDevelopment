...
export default function StatusPanel() {
    ...
    const getContainerName = (key: string): string => {
        const map: Record<string, string> = {
            'orchestrator': 'content_creation-orchestrator',
            'content_builder': 'content_creation-content_builder',
            'image_generator': 'content_creation-image_generator',
            'customer_service': 'content_creation-customer_service',
            'status': 'content_creation-phoenix' // Mapping System Core to Phoenix/Telemetry for now
        };
        return map[key] || key;
    };
