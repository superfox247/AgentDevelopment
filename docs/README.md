...
- Engineering architecture, CI/CD, deployment, operations, runbooks, GCP setup

2. [Product Features Guide](PRODUCT_FEATURES.md)
- User-facing and API-facing feature behavior, flows, and capability map
