...
def create_knowledge_item(title: str, description: str, sources: list[str]):
    ...
    if ki_dir.exists():
        print(f"Warning: Knowledge Item '{topic_name}' already exists.")
    else:
        print(f"Creating directory: {ki_dir}")
    ...
    print("Next step: Edit the artifacts in .agent/knowledge/")
...
if __name__ == "__main__":
    ...
    parser.add_argument("--sources", nargs="*", default=[], help="List of source URLs or IDs")
