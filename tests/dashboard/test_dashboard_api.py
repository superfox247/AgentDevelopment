...
class TestSystemRoutes:
    ...
    @pytest.mark.asyncio
    async def test_get_status_returns_system_status(
        self, mock_docker_client: MagicMock
    ) -> None:
        """Test /api/status returns system status."""
        with patch(
            "frontend.dependencies.get_docker_client",
    ...
    async def test_list_artifacts_returns_list(self) -> None:
        ...
        with patch("frontend.routers.system.ARTIFACTS_DIR") as mock_dir:
...
class TestDockerRoutes:
    ...
    @pytest.mark.asyncio
    async def test_docker_container_control_invalid_action(
        self, mock_docker_client: MagicMock
    ) -> None:
