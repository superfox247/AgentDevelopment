"""Unit tests for base agent callbacks."""

from unittest.mock import MagicMock

from agents.base_agent.callbacks.visibility import (
    after_agent_log,
    after_tool_log,
    before_agent_log,
    before_tool_log,
...
class TestBeforeToolLog:
    ...
    def test_before_tool_log_with_tool_name(self) -> None:
        ...
        before_tool_log(tool, args, tool_context)
...
class TestAfterToolLog:
    ...
    def test_after_tool_log_with_tool_name(self) -> None:
        ...
        args = {"text": "hello"}
        tool_context = MagicMock()
        tool_response = {"result": "hello"}

        after_tool_log(tool, args, tool_context, tool_response)
